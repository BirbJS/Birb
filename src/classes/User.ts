...
export default class User extends BaseUser {
     ...
     * Build this User.
     * 
     * @param {any} data The data to build this User with.
     * @returns {User} This User instance.
     */
    private build (data: any): User {
     ...
     * 
     * @param {UserResolvable} user The user to convert.
     * @returns {string} The user ID.
     */
    protected static toIdOnly (user: UserResolvable): string {
